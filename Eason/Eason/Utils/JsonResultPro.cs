...
public class JsonResultPro : JsonResult
    {
    public enum DateTimeFormatType { FullDateTime, ShortDateTime }
        ...
        public JsonResultPro(object data, DateTimeFormatType dateTimeFormat, JsonRequestBehavior behavior)
        {
            base.Data = data;
            base.JsonRequestBehavior = behavior;
            ...
            switch (dateTimeFormat)
            {
                case DateTimeFormatType.FullDateTime:
                    this.DateTimeFormat = "yyyy/MM/dd hh:mm:ss";
                    break;
                case DateTimeFormatType.ShortDateTime:
